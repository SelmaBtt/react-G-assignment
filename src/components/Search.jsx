...
const Search=({ setSearchInputValue })=> {
    ...
    return(
        <div className={styled.divWrapper}>
            <input className={styled.searchInput} ref={searchInput} onChange={() => setSearchInputValue(searchInput.current.value)} type="text" /> {/* "onChange"=eveytime change happens in the input. "setSeachInputValue" is a useState prop from FetchAPI.jsx, is the value that affects the API */}
